...
\label{sect:describe} 
Even though you probably want to jump immediately to factor analyze your data, this is a mistake.  It is very important to first describe them and look for weird responses.  
...
See the vignette: Introduction to the psych pacakge for examples of mediation and moderation analysis.
